...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer practice and local match play",
    ...
    "Drama Club": {
        "description": "Acting practice, stage production, and theatrical performance",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["mia@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop persuasive speaking, research, and argument skills",
